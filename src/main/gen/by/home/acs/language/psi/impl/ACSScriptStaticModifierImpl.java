...
public class ACSScriptStaticModifierImpl extends ASTWrapperPsiElement implements ACSScriptStaticModifier {

  public ACSScriptStaticModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
