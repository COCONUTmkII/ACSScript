...
public class ACSScriptReturnOperatorImpl extends ASTWrapperPsiElement implements ACSScriptReturnOperator {

  public ACSScriptReturnOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ACSScriptVisitor visitor) {
    visitor.visitReturnOperator(this);
  }
