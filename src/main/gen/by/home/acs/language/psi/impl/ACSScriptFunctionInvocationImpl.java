...
public class ACSScriptFunctionInvocationImpl extends ASTWrapperPsiElement implements ACSScriptFunctionInvocation {

  public ACSScriptFunctionInvocationImpl(@NotNull ASTNode node) {
    super(node);
  }
