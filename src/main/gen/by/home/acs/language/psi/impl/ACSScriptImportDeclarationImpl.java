...
public class ACSScriptImportDeclarationImpl extends ASTWrapperPsiElement implements ACSScriptImportDeclaration {

  public ACSScriptImportDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
