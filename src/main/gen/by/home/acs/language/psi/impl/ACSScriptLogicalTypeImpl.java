...
public class ACSScriptLogicalTypeImpl extends ASTWrapperPsiElement implements ACSScriptLogicalType {

  public ACSScriptLogicalTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ACSScriptVisitor visitor) {
    visitor.visitLogicalType(this);
  }
