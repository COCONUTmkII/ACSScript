...
public class ACSScriptEmptyStringImpl extends ASTWrapperPsiElement implements ACSScriptEmptyString {

  public ACSScriptEmptyStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ACSScriptVisitor visitor) {
    visitor.visitEmptyString(this);
  }
