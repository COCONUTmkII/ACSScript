...
public class ACSScriptVariableInitializationImpl extends ASTWrapperPsiElement implements ACSScriptVariableInitialization {

  public ACSScriptVariableInitializationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ACSScriptEmptyString getEmptyString() {
    return findChildByClass(ACSScriptEmptyString.class);
  }
