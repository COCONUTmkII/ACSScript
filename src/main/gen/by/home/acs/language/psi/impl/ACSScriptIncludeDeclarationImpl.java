...
public class ACSScriptIncludeDeclarationImpl extends ASTWrapperPsiElement implements ACSScriptIncludeDeclaration {

  public ACSScriptIncludeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
