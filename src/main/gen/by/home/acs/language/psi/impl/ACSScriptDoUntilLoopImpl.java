...
public class ACSScriptDoUntilLoopImpl extends ASTWrapperPsiElement implements ACSScriptDoUntilLoop {

  public ACSScriptDoUntilLoopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ACSScriptVisitor visitor) {
    visitor.visitDoUntilLoop(this);
  }
