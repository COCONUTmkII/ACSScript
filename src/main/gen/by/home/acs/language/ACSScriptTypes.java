...
public interface ACSScriptTypes {
  ...
  IElementType BOOL_TYPE = new ACSScriptElementType("BOOL_TYPE");
  ...
  IElementType EMPTY_STRING = new ACSScriptElementType("EMPTY_STRING");
  ...
  IElementType INT_TYPE = new ACSScriptElementType("INT_TYPE");
  ...
  IElementType STRING_TYPE = new ACSScriptElementType("STRING_TYPE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ARRAY_INITIALIZER) {
        ...
        return new ACSScriptBoolTypeImpl(node);
      }
        ...
        return new ACSScriptEmptyStringImpl(node);
      }
        ...
        return new ACSScriptIntTypeImpl(node);
      }
        ...
        return new ACSScriptStringTypeImpl(node);
      }
