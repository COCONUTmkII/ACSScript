...
public class ACSScriptSyntaxAttributeKeySupplier {
    ...
    static {
      ...
      //  elements.put(ACSScriptTypes.FUNCTION_RETURN_TYPE, () -> new TextAttributesKey[]{KEY});
        elements.put(ACSScriptTypes.INT_TYPE, () -> new TextAttributesKey[]{KEY});
        ...
        elements.put(ACSScriptTypes.BOOL_TYPE, () -> new TextAttributesKey[]{KEY});
        ...
        elements.put(ACSScriptTypes.VOID_TYPE, () -> new TextAttributesKey[]{KEY});
        elements.put(ACSScriptTypes.STRING_TYPE, () -> new TextAttributesKey[]{KEY});
